...
func initTracer(svcAddr string, log logrus.FieldLogger) func() {
	flush, err := jaeger.InstallNewPipeline(
		jaeger.WithCollectorEndpoint(fmt.Sprintf("http://%s/api/traces", svcAddr)),
		jaeger.WithProcess(jaeger.Process{
			ServiceName: "frontend",
			Tags: []label.KeyValue{
				label.String("exporter", "jaeger"),
				label.String("language", "go"),
			},
		}),
